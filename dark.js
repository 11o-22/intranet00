...
박힐 시에는 신음을 참지 않고 냅니다.
사원이 행위를 원할 시 상대방에게 맞게 행동해요.
다리를 벌리는 것이나 박는 행위도 거리낌 없어요.`;
...
"요즘 거울 쪽 이야기를 하시는 분이 많아요"`,
    ...
    const GOHYEONG_DIALOGUE = {
        intro: `눈을 뜬다.<br><br>
            천장이 낮다. 손을 뻗으면 닿을 것 같은 높이다.<br>
            벽은 네 면 다 같은 재질이며, 이음새가 없다.<br>
            바닥이 미지근한게, 꽤 오래 누워있던 것 같다.<br><br>
            문득 기척이 느껴져 옆을 보면, 일어나고 있는 사람이 보인다. 아는 얼굴.<br>
            동시에 깨어난 듯 하다..<br><br>
            상황을 파악하며 고개를 돌려 본다. 문에 손잡이가 없다.<br>
            벽에 글씨가 떠올랐다.<br><br>
            <span style="color:#7fd4d4;">"이제부터 당신들은 이 곳에서 나가야 합니다."</span>`,
        ...
        fail: `천장이 어깨에 닿아요.<br><br>
            ...
            눈을 감았다 뜨니 복도예요. 둘 다 무사해요.<br>
            다만 아무것도 가지고 나오지 못했어요.`
    };

    const GOHYEONG_ROOMS = [
        {
            id: 'hand',
            scene: `방이 좁아요. 세 걸음이면 끝에서 끝이에요.<br><br>
                바닥에 손바닥 자국이 두 개 찍혀 있어요.<br>
                나란히가 아니라 마주 보고 있어요. 크기가 서로 달라요.<br><br>
                자국 사이에 얇은 선이 그어져 있어요.<br>
                선을 넘으려고 하면 발이 무거워져요.`,
            truth: '두 사람이 선을 사이에 두고 손을 맞잡으면 문이 열려요. 한쪽만 내미는 건 소용없어요. 양쪽이 동시에 잡아야 해요.',
            reaction: '자국에 손을 대면 미지근해져요. 혼자 손을 내밀면 자국이 잠깐 밝아지다 꺼져요.',
            nudge: [
                '자국이 두 개예요. 서로 마주 보고 있어요.',
                '혼자 손을 대면 잠깐 밝아지다 꺼져요.',
                '두 손이 만나야 할 것 같아요.'
            ],
            clear: '두 사람이 각각 손을 잡거나 맞잡는 행동을 서술했을 때'
        },
        {
            id: 'circle',
            scene: `방 가운데에 원이 그려져 있어요.<br><br>
                한 사람이 서기엔 크고, 두 사람이 서기엔 작아요.<br>
                원 밖 바닥은 축축해요. 원 안만 말라 있어요.<br><br>
                벽이 아주 천천히 좁아지고 있어요.<br>
                서두르지 않는 속도예요.`,
            truth: '두 사람이 원 안에 함께 들어가려면 서로 끌어안아야 해요. 그렇게 하면 문이 열려요.',
            reaction: '원 밖에 서 있으면 벽이 계속 좁아져요. 한 사람만 원 안에 서면 아무 일도 없어요.',
            nudge: [
                '원이 한 사람에겐 크고 둘에겐 작아요.',
                '원 밖은 축축하고 안은 말라 있어요.',
                '둘 다 들어가려면 붙어야 할 것 같아요.'
            ],
            clear: '두 사람이 서로 끌어안거나 안는 행동을 서술했을 때'
        },
        {
            id: 'pillar',
            scene: `방 가운데에 기둥이 하나 서 있어요.<br><br>
                기둥 표면에 등을 기댄 자국이 두 개 있어요.<br>
                서로 정반대 방향이에요.<br><br>
                기둥을 밀면 꿈쩍하지 않아요.<br>
                기둥을 사이에 두면 서로가 보이지 않아요.`,
            truth: '두 사람이 기둥을 사이에 두고 각각 등을 기대면 문이 열려요. 서로 보이지 않는 채로 등을 맞대는 셈이에요.',
            reaction: '혼자 기대면 자국이 흐려져요. 마주 보면 아무 일도 없어요.',
            nudge: [
                '기댄 자국이 서로 반대편에 있어요.',
                '혼자 기대면 자국이 흐려져요.',
                '둘 다 기대야 할 것 같아요.'
            ],
            clear: '두 사람이 각각 기둥에 기대거나 등을 대는 행동을 서술했을 때'
        },
        {
            id: 'cold',
            scene: `방이 차가워요. 숨을 쉬면 입김이 보여요.<br><br>
                벽에 온도계가 하나 걸려 있어요. 바늘이 아래쪽에 있어요.<br>
                바닥에 담요가 한 장 놓여 있어요. 한 사람이 덮기엔 넉넉하고,<br>
                두 사람이 덮기엔 모자라요.<br><br>
                문 옆에 눈금이 있어요. 온도계 바늘이 그 눈금까지 올라가야 할 것 같아요.`,
            truth: '두 사람이 담요를 함께 덮고 붙어 있으면 체온이 올라 온도계 바늘이 눈금에 닿아요. 그때 문이 열려요.',
            reaction: '혼자 담요를 덮으면 바늘이 조금 오르다 멈춰요. 담요를 나눠서 각자 덮으면 바늘이 오르지 않아요.',
            nudge: [
                '담요가 한 장뿐이에요.',
                '혼자 덮으면 바늘이 조금 오르다 멈춰요.',
                '더 올리려면 다른 방법이 필요해요.'
            ],
            clear: '두 사람이 담요를 함께 덮거나 붙어서 체온을 나누는 행동을 서술했을 때'
        },
        {
            id: 'eye',
            scene: `한쪽 벽이 전부 거울이에요.<br><br>
                거울 앞 바닥에 발자국이 두 쌍 있어요.<br>
                아주 가까이 마주 보고 선 자국이에요. 발끝이 거의 닿아요.<br><br>
                거울 속에는 아무것도 비치지 않아요.<br>
                사람도, 방도, 아무것도요.`,
            truth: '두 사람이 발자국 위에 마주 서서 서로의 눈을 오래 들여다보면, 거울에 두 사람이 비치기 시작해요. 그때 문이 열려요.',
            reaction: '따로 서면 거울이 계속 비어 있어요. 거울을 만지면 미지근해요.',
            nudge: [
                '발자국이 아주 가까이 마주 보고 있어요.',
                '거울에 아무것도 비치지 않아요.',
                '비치게 하려면 무언가 필요한 것 같아요.'
            ],
            clear: '두 사람이 마주 보고 서로의 눈을 들여다보는 행동을 각각 서술했을 때'
        },
        {
            id: 'weight',
            scene: `방 양쪽 끝에 발판이 하나씩 있어요.<br><br>
                발판에 올라서면 조금 내려가요. 그런데 금세 다시 올라와요.<br>
                혼자서는 충분히 눌리지 않는 모양이에요.<br><br>
                두 발판은 서로 멀어요. 동시에 밟을 수는 없어요.<br>
                천장에서 줄이 두 가닥 내려와 있어요.`,
            truth: '한 사람이 발판에 서고 다른 사람이 업히거나 안겨서 무게를 합치면 발판이 끝까지 눌려요. 두 발판 중 하나만 그렇게 해도 돼요.',
            reaction: '혼자 밟으면 조금 내려가다 올라와요. 줄을 당기면 늘어나기만 해요.',
            nudge: [
                '혼자 밟으면 충분히 눌리지 않아요.',
                '두 발판을 동시에 밟을 수는 없어요.',
                '무게를 모아야 할 것 같아요.'
            ],
            clear: '한 사람이 다른 사람을 업거나 안아서 한 발판에 무게를 싣는 행동을 서술했을 때'
        },
        {
            id: 'dark',
            scene: `불이 꺼져 있어요. 아무것도 보이지 않아요.<br><br>
                손을 뻗어도 벽이 어디인지 모르겠어요.<br>
                소리도 이상하게 먹혀요. 목소리가 멀리 가지 않아요.<br><br>
                어딘가에서 아주 약한 빛이 새어 나와요.<br>
                한 사람이 가기엔 멀어 보여요.`,
            truth: '두 사람이 서로를 붙잡거나 손을 잡고 함께 빛 쪽으로 움직이면 문에 닿아요. 떨어지면 방향을 잃어요.',
            reaction: '혼자 움직이면 몇 걸음 만에 방향을 잃어요. 소리쳐 불러도 위치를 알 수 없어요.',
            nudge: [
                '혼자 움직이면 방향을 잃어요.',
                '목소리가 멀리 가지 않아요.',
                '떨어지지 않는 방법이 필요해요.'
            ],
            clear: '두 사람이 서로 붙잡거나 손을 잡은 채로 함께 이동하는 행동을 서술했을 때'
        }
    ];

    const GOHYEONG_FINAL = {
        id: 'final',
        scene: `지금까지와 다른 방이에요.<br><br>
            벽에 글자가 빼곡히 적혀 있어요. 읽어 보면 지나온 방에서 오갔던 말들이에요.<br>
            두 사람이 나눈 것이 전부 적혀 있어요. 사소한 것까지요.<br><br>
            가운데에 의자가 두 개 놓여 있어요. 마주 보고 있어요.<br>
            의자 사이가 아주 가까워요. 앉으면 무릎이 닿아요.<br><br>
            벽에 한 줄이 떠 있어요.<br><br>
            <span style="color:#7fd4d4;">"번갈아 가며, 상대의 좋은 점을 말하십시오."</span><br>
            <span style="color:#7fd4d4;">"세 번씩입니다."</span>`,
        truth: '두 사람이 번갈아 가며 상대의 좋은 점을 말해야 해요. 한 사람당 세 번씩, 총 여섯 번이에요. 같은 내용을 반복하면 세지 않아요. 여섯 번이 채워지면 문이 열려요.',
        reaction: '자기 자랑을 하면 벽의 글자가 번져요. 상대에 대한 말이 아니면 벽이 반응하지 않아요. 같은 말을 또 하면 이미 새겨진 글자 위에 겹쳐 흐려져요.',
        nudge: [
            '벽에 글자가 하나씩 새로 새겨지고 있어요.',
            '한 사람 것만 새겨져 있어요. 다른 쪽은 아직 비어 있어요.',
            '여섯 줄이 채워져야 할 것 같아요.'
        ],
        clear: '두 사람이 각각 상대의 좋은 점을 세 번씩, 총 여섯 번 말했을 때. 중복된 내용이나 자기 자랑은 세지 않아요. narration에 현재 몇 번째인지 기록해야 해요.'
    };