...
const DNA_GIFTS = [
    ...
    { n:'그림자가 없는 촛대', e:{ luck:2, pct:430 }, p:100, d:'행운 2회 · 공용시설 행운 430%' },
    { n:'바람이 새긴 문양', e:{ fac:6, pct:430 }, p:100, d:'공용시설 행운 430% · 공용시설 +6회' },
    { n:'빗물로 만든 방울', e:{ eva:2, pct:420 }, p:100, d:'회피 2회 · 공용시설 행운 420%' },
    { n:'시들지 않는 마른 잎', e:{ eva:3, pct:380 }, p:100, d:'회피 3회 · 공용시설 행운 380%' },
    { n:'온기가 남은 재', e:{ eva:4, pct:340 }, p:100, d:'회피 4회 · 공용시설 행운 340%' },
    { n:'파도가 놓고 간 열쇠', e:{ dark:3, gim:1 }, p:100, d:'기믹 파훼 1회 · 어둠 탐사 +3회' },
    { n:'무게가 없는 열매', e:{ dark:1, pct:410 }, p:100, d:'공용시설 행운 410% · 어둠 탐사 +1회' },
    { n:'은빛으로 굳은 물방울', e:{ luck:3, pct:390 }, p:100, d:'행운 3회 · 공용시설 행운 390%' },
    { n:'소리를 삼킨 종', e:{ fac:8, pct:400 }, p:99, d:'공용시설 행운 400% · 공용시설 +8회' },
    { n:'계절을 건너뛴 봉오리', e:{ gim:1, pct:360 }, p:99, d:'기믹 파훼 1회 · 공용시설 행운 360%' },
    { n:'젖지 않는 종이배', e:{ dark:2, pct:320 }, p:99, d:'공용시설 행운 320% · 어둠 탐사 +2회' },
    { n:'빛으로 엮은 매듭', e:{ eva:3, gim:2 }, p:98, d:'기믹 파훼 2회 · 회피 3회' },
    { n:'하늘색 조각 퍼즐', e:{ dark:2, fac:8, gim:1 }, p:102, d:'기믹 파훼 1회 · 어둠 탐사 +2회 · 공용시설 +8회' },
    { n:'반쯤 녹은 서리 꽃', e:{ dark:2, eva:4, luck:2 }, p:102, d:'회피 4회 · 행운 2회 · 어둠 탐사 +2회' },
    { n:'잠들지 않는 등불', e:{ dark:2, eva:4, fac:6 }, p:102, d:'회피 4회 · 어둠 탐사 +2회 · 공용시설 +6회' },
    { n:'물결이 멈춘 유리병', e:{ dark:3, fac:6, luck:2 }, p:102, d:'행운 2회 · 어둠 탐사 +3회 · 공용시설 +6회' },
    { n:'숨을 쉬는 모래시계', e:{ eva:2, fac:7, pct:340 }, p:101, d:'회피 2회 · 공용시설 행운 340% · 공용시설 +7회' },
    { n:'안개로 짠 손수건', e:{ fac:6, luck:2, pct:360 }, p:101, d:'행운 2회 · 공용시설 행운 360% · 공용시설 +6회' },
    { n:'여덟 번 접힌 종이학', e:{ dark:1, fac:8, pct:320 }, p:101, d:'공용시설 행운 320% · 어둠 탐사 +1회 · 공용시설 +8회' },
    { n:'녹지 않는 얼음 열쇠', e:{ eva:4, gim:1, luck:3 }, p:101, d:'기믹 파훼 1회 · 회피 4회 · 행운 3회' },
    { n:'소리가 나지 않는 방울', e:{ dark:2, eva:3, luck:3 }, p:101, d:'회피 3회 · 행운 3회 · 어둠 탐사 +2회' },
    { n:'노을을 가둔 호박', e:{ dark:2, fac:7, luck:4 }, p:101, d:'행운 4회 · 어둠 탐사 +2회 · 공용시설 +7회' },
    { n:'이슬이 굳은 목걸이', e:{ eva:2, luck:2, pct:350 }, p:100, d:'회피 2회 · 행운 2회 · 공용시설 행운 350%' },
    { n:'금이 가지 않는 거울 조각', e:{ eva:3, luck:2, pct:310 }, p:100, d:'회피 3회 · 행운 2회 · 공용시설 행운 310%' },
    { n:'별자리를 옮긴 지도', e:{ eva:2, fac:6, pct:350 }, p:100, d:'회피 2회 · 공용시설 행운 350% · 공용시설 +6회' },
    { n:'심장을 닮은 씨앗', e:{ eva:3, fac:6, pct:310 }, p:100, d:'회피 3회 · 공용시설 행운 310% · 공용시설 +6회' },
    { n:'잠긴 물의 반지', e:{ fac:7, luck:3, pct:310 }, p:100, d:'행운 3회 · 공용시설 행운 310% · 공용시설 +7회' },
    { n:'구름을 뜬 국자', e:{ dark:1, fac:7, pct:330 }, p:100, d:'공용시설 행운 330% · 어둠 탐사 +1회 · 공용시설 +7회' },
    { n:'천천히 도는 팽이', e:{ dark:1, luck:2, pct:340 }, p:100, d:'행운 2회 · 공용시설 행운 340% · 어둠 탐사 +1회' },
    { n:'깃털보다 가벼운 돌', e:{ fac:6, luck:3, pct:320 }, p:100, d:'행운 3회 · 공용시설 행운 320% · 공용시설 +6회' },
    { n:'두 번 피는 꽃봉오리', e:{ dark:1, fac:6, pct:340 }, p:100, d:'공용시설 행운 340% · 어둠 탐사 +1회 · 공용시설 +6회' },
    { n:'이름이 지워진 부적', e:{ eva:3, gim:1, luck:4 }, p:100, d:'기믹 파훼 1회 · 회피 3회 · 행운 4회' },
    { n:'빛을 먹는 수정', e:{ dark:2, eva:2, luck:4 }, p:100, d:'회피 2회 · 행운 4회 · 어둠 탐사 +2회' },
    { n:'흐르지 않는 모래', e:{ eva:4, fac:8, luck:4 }, p:100, d:'회피 4회 · 행운 4회 · 공용시설 +8회' },
    { n:'하늘을 비춘 손거울', e:{ eva:2, luck:3, pct:310 }, p:100, d:'회피 2회 · 행운 3회 · 공용시설 행운 310%' },
    { n:'뒤집히지 않는 모래시계', e:{ dark:1, eva:2, pct:330 }, p:100, d:'회피 2회 · 공용시설 행운 330% · 어둠 탐사 +1회' },
    { n:'달빛으로 뜬 실타래', e:{ fac:8, luck:2, pct:330 }, p:100, d:'행운 2회 · 공용시설 행운 330% · 공용시설 +8회' },
    { n:'빛이 새는 조약돌', e:{ eva:2, fac:8, pct:320 }, p:99, d:'회피 2회 · 공용시설 행운 320% · 공용시설 +8회' },
    { n:'닫히지 않는 작은 문', e:{ dark:1, luck:3, pct:300 }, p:99, d:'행운 3회 · 공용시설 행운 300% · 어둠 탐사 +1회' },
    { n:'별을 세던 주판', e:{ fac:7, luck:2, pct:340 }, p:99, d:'행운 2회 · 공용시설 행운 340% · 공용시설 +7회' },
    { n:'녹슬지 않는 나사', e:{ dark:2, fac:7, gim:1 }, p:99, d:'기믹 파훼 1회 · 어둠 탐사 +2회 · 공용시설 +7회' },
    { n:'돌아오지 않는 부메랑', e:{ dark:2, eva:2, gim:1 }, p:98, d:'기믹 파훼 1회 · 회피 2회 · 어둠 탐사 +2회' },
    { n:'얼지 않는 샘물 한 방울', e:{ eva:4, fac:8, gim:1 }, p:98, d:'기믹 파훼 1회 · 회피 4회 · 공용시설 +8회' },
    { n:'떨어지지 않는 낙엽', e:{ dark:1, eva:4, luck:4 }, p:98, d:'회피 4회 · 행운 4회 · 어둠 탐사 +1회' },
    { n:'시간이 비껴간 태엽', e:{ dark:2, eva:3, fac:8 }, p:98, d:'회피 3회 · 어둠 탐사 +2회 · 공용시설 +8회' },
    { n:'처음을 기억하는 단추', e:{ dark:2, fac:6, luck:4 }, p:98, d:'행운 4회 · 어둠 탐사 +2회 · 공용시설 +6회' },
    { n:'달을 삼킨 조개', e:{ eva:2, fac:7, gim:1, luck:3 }, p:102, d:'기믹 파훼 1회 · 회피 2회 · 행운 3회 · 공용시설 +7회' },
    { n:'뿌리 없는 유리 꽃', e:{ dark:1, fac:6, gim:1, luck:3 }, p:101, d:'기믹 파훼 1회 · 행운 3회 · 어둠 탐사 +1회 · 공용시설 +6회' },
    { n:'밤을 적신 리본', e:{ dark:1, eva:4, fac:7, luck:2 }, p:101, d:'회피 4회 · 행운 2회 · 어둠 탐사 +1회 · 공용시설 +7회' },
    { n:'메아리를 담은 잔', e:{ eva:3, fac:6, gim:1, luck:2 }, p:100, d:'기믹 파훼 1회 · 회피 3회 · 행운 2회 · 공용시설 +6회' },
    { n:'서리로 쓴 편지', e:{ dark:1, eva:2, fac:8, gim:1 }, p:100, d:'기믹 파훼 1회 · 회피 2회 · 어둠 탐사 +1회 · 공용시설 +8회' },
    { n:'꺼지지 않는 반딧불', e:{ dark:2, eva:2, fac:6, luck:2 }, p:100, d:'회피 2회 · 행운 2회 · 어둠 탐사 +2회 · 공용시설 +6회' },
    { n:'바늘 없는 나침반', e:{ dark:1, eva:3, fac:7, luck:3 }, p:100, d:'회피 3회 · 행운 3회 · 어둠 탐사 +1회 · 공용시설 +7회' },
    { n:'숨을 참은 풍선', e:{ eva:2, fac:6, gim:1, luck:3 }, p:99, d:'기믹 파훼 1회 · 회피 2회 · 행운 3회 · 공용시설 +6회' },
    { n:'안개가 고인 병뚜껑', e:{ dark:1, eva:2, fac:7, luck:4 }, p:99, d:'회피 2회 · 행운 4회 · 어둠 탐사 +1회 · 공용시설 +7회' }
];
